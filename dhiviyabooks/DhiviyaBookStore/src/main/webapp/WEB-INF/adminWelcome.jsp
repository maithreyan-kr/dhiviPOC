...
<div class="search">
 <form:form action="searchAdmin" method="get" modelAttribute="search">
...
<tr>  
<th>Book Id</th>  
<th><a href="sortBooknameAdmin">L</a> Book Name<a href="sortBooknameAdminDES">H</a></th>  
 
<th>Category</th> 
<th>Author</th> 
<th> <a href="sortPriceAdmin">L</a> Price <a href="sortPriceAdminDES">H</a></th>  
<th>Delete Book</th> 
</tr>  
...
<td><a href="deleteBook/${ta.bookId}" > delete </a></td> 
</tr>  
</c:forEach>  
</table>
</form:form>
 ...
 <div class="reg">
 <form action="addBook" class="crud">
